...
export const environment = {
  ...
  PARAMETROS_CRUD_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/parametros_crud/v1/', // --------------------------------
  ...
  EVALUACION_DOCENTE_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/evaluaciones_mongo_crud/v1/', // ---------------------
